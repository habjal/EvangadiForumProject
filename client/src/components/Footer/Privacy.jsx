  ...
  return (
    <div className={Classes.terms}>
      ...
      <div className={Classes.termsPara}>
        <h5>Privacy Policy of evangadi.com</h5>
        <p>
        ...
        <p>
          ...
          <br /> We collect the content and other information you provide when
          you use our Services, including when you sign up for an account,
          create or share, and message or communicate with others. This can
          include information in or about the content you provide, such as the
          ...
          activities.
          <br /> We also collect content and information that other people
          provide when they use our Services, including information about you,
          such as when they share a photo of you, send a message to you, or
          upload, sync or import your contact information. <br />
          ...
          other devices where you install or access our Services, depending on
          the permissions you’ve granted. We may associate the information we
        ...
        <p>
          ...
          following ways:
          <br />
          <b>Personalize your experience :</b> Personalize your experience : We
          use the information we collect including your user id to help us
          provide and improve the content and advertising you see when using our
          services. (your information helps us to better respond to your
          individual needs)
          <br />
          <b>Improve our Services :</b> We continually strive to improve our
          website offerings based on the information and feedback we receive
          from you.
          <br />
          <b>Send you messages:</b> We may use the email address you may provide
          on registration to send periodical updates as part of our service and
          ...
          inquiries, and/or other requests or questions. <br /> We use your
          information to send you marketing communications, communicate with you
          about our Services and let you know about our policies and terms. We
        ...
        <p>
          ...
          <br /> If new owner or control of all or part of our Services or their
        ...
        <p>
          ...
          <br /> We offer the use of a secure server. All supplied information
          is encrypted before entered into our database to be only accessed by
        ...
        <p>
          ...
          third-party service providers to assist us in better understanding our
        ...
        <h5>How can I manage or delete information about me?</h5>
        <p>
        ...
        <h5>How do we respond to legal requests or prevent harm?</h5>
        <p>
        ...
        <p>
          ...
          Policy modification date below. <br />
